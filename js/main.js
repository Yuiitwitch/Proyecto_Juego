...
<div class="boton1" id="carrera" onclick="acelerar()"><button>GO!</button></div> 
  ...
  const acelerar1 = () => {
    ...
    document.getElementById("distanceh1").innerHTML = `Metros recorridos P1: ${player1.distance}`;
  }
  const acelerar2 = () => {
    ...
    document.getElementById("distanceh2").innerHTML = `Metros recorridos P2: ${player2.distance}`;
  }
  const acelerar = () => {
    acelerar1();
    acelerar2();
  ...
  const comparar = () => {
    ...
    if (player1.distance < metros && player2.distance < metros) {
      ...
      if (player1.distance > player2.distance && player2.distance < player1.distance) {
        ...
        console.log(`El ganaor es ${player2.nombre}`)
  ...
  const final = () => {
    ...
    <div>
        <button id="restart" type="button" onclick='("1")'>RESTART</button>
    </div>
    `;
  }
